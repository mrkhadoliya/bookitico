        ...
        if (
            ...
            try {
                ...
                if (count($data['series']) > 0 && isset($data['series'][0]['data']) && count($data['series'][0]['data']) > 100) {
                    ...
                    $optionSetting['xaxis']['tickAmount'] = !empty($settings['iq_' . $type . 'chart_xaxis_datalabel_tick_amount']) && 20 > (int)$settings['iq_' . $type . 'chart_xaxis_datalabel_tick_amount'] ? (int)$settings['iq' . $type . '_chart_xaxis_datalabel_tick_amount'] : 20;
                    $instantInit = true;
                }
