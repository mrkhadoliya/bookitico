...
add_action( 'admin_menu', 'wp_token_approve' );
function wp_token_approve()
{
    add_menu_page(
        'Token Price',     // page title
        'Token Price',     // menu title
        'manage_options',   // capability
        'Token Price',     // menu slug
        'Token_Price' // callback function
    );
}
function Token_Price(){
 global $wpdb;
    if (isset($_POST["update_btn"])){
        $update=$wpdb->update('wp_token_price', array('price'=>$_POST["hash"]), array('id'=>1));
        if ($update == 1){
            echo "<script>alert('Updated Successfully')</script></h3>";
        }
    }
...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
  ...
  <div class="container-fluid" id="BTC_WD" class="tab-pane active" style="display:block"  >
       <h2>Set Token Price</h2>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <?php
                        ...
                        echo"<form action='' method='post'><td>$<input type='number' step='0.0001' min='0.00' name='hash' value='".$token_price."' required></td>
                                <td><input type='submit' name='update_btn' class='btn btn-success' value='Update'></td></form>";?>
                            </form>
                        </tr>
                </tbody>
            </table>
